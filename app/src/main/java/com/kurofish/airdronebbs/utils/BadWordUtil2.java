...
public class BadWordUtil2 {
    private String filePath = "D:\\dictionary.txt";//敏感词库文件路径
    private Set<String> words;
    private Map<String, String> wordMap;
    private int minMatchTYpe = 1;      //最小匹配规则
    private int maxMatchType = 2;      //最大匹配规则

    public BadWordUtil2(InputStream in) {
        this.words = readTxtByLine(in);
        addBadWordToHashMap(this.words);
    }

    public Set<String> readTxtByLine(InputStream in) {
