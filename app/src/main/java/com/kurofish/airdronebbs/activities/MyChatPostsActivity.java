...
public class MyChatPostsActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_my_chat_posts);
        ...
        recyclerView = findViewById(R.id.myChatPostsRecyclerView);
        recyclerView.setLayoutManager(new LinearLayoutManager(MyChatPostsActivity.this));
        showMyPosts();
    }
    ...
    private void showMyPosts() {
        ...
        adapter = new FirestoreRecyclerAdapter<BbsPost, MyChatPostsActivity.CardViewHolder>(response) {
            @SuppressLint("RestrictedApi")
            @Override
            public void onBindViewHolder(@NonNull MyChatPostsActivity.CardViewHolder holder, int position, @NonNull BbsPost model) {
                        ...
                        query1.get()
                                .addOnSuccessListener(new OnSuccessListener<QuerySnapshot>() {
                                    ...
                                    public void onSuccess(QuerySnapshot queryDocumentSnapshots) {
                                        ...
                                        Intent intent = new Intent(MyChatPostsActivity.this, PostDetailActivity.class);
            ...
            @NonNull
            @Override
            public MyChatPostsActivity.CardViewHolder onCreateViewHolder(@NonNull ViewGroup group, int i) {
                View view = LayoutInflater.from(group.getContext())
                        .inflate(R.layout.item_bbs_post, group, false);

                return new MyChatPostsActivity.CardViewHolder(view);
            }
